...
Current version: **1.3.3** (v1 architecture).
...
Removed from 0.x: internal camera/light, surface list, thickness,
bend/curl/twist, border modes, rotation-origin modes, output-bounds modes,
