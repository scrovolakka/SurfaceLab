...
| `SurfaceLabUI` | Static v1 parameter declaration, division changes, and variable-point Composition gizmo |
...
```sh
cmake --build work/build/tests-v1
ctest --test-dir work/build/tests-v1 --output-on-failure
cmake --build work/build/plugin-v1
```
